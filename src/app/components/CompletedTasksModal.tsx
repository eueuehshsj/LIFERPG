        ...
        <div className="px-8 pt-6 pb-4 border-b-2 border-dashed border-amber-800/30 shrink-0">
          ...
          <div className="flex justify-center gap-4 mt-3">
            <div className="text-center">
              <span
                className="font-black text-stone-700"
                style={{ fontFamily: "serif", fontSize: "18px" }}
              >
                {completedTasks.length}
              </span>
              <span
                className="text-stone-500 text-xs ml-1"
        ...
        <div className="flex-1 overflow-y-auto px-8 py-5">
          {completedTasks.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-12 gap-3">
              ...
              />
              <p
                className="text-stone-400 font-bold text-sm text-center"
                style={{ fontFamily: "serif" }}
              >
                아직 해결한 퀘스트가 없습니다
              </p>
              ...
              {completedTasks.map((task, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    >
                      <span
                        className="text-red-700 font-black text-[9px] text-center leading-tight"
                        style={{ fontFamily: "serif" }}
                      >
                        완료
                      </span>
                    ...
                    <div className="relative px-4 py-3 pr-16">
                      <div className="absolute top-3 right-3 z-10 flex flex-col items-end gap-2 max-w-[200px]">
                        {confirmDeleteId === task.id ? (
                          ...
                          <button
                            ...
                            className="rounded-full bg-stone-800 px-3 py-1 text-[11px] font-bold text-stone-100 transition hover:bg-stone-900"
                            style={{ fontFamily: "serif" }}
                          >
                            삭제
                          </button>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          {/* 제목 */}
                          <div
                            className="font-black text-stone-800 leading-snug"
                          ...
                          <div className="flex justify-between items-center mt-2">
                            ...
                            <span
                              className="font-black text-amber-700 text-[11px]"
                              style={{ fontFamily: "serif" }}
                            >
                              +{task.reward}pt
                            </span>
