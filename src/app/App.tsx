      ...
      <div className="flex justify-center py-6">
        <div className="relative">
          ...
          >
            ...
            {/* 나무못 장식 */}
            <div
              className="absolute top-3 left-3 w-4 h-4 rounded-full bg-gradient-to-br from-stone-800 to-stone-950"
              style={{
                boxShadow:
            ...
            />
            <div
              className="absolute top-3 right-3 w-4 h-4 rounded-full bg-gradient-to-br from-stone-800 to-stone-950"
              style={{
                boxShadow:
                  "inset 0 2px 3px rgba(0,0,0,0.8), 0 1px 2px rgba(0,0,0,0.5)",
              }}
            />
            <div
              className="absolute bottom-3 left-3 w-4 h-4 rounded-full bg-gradient-to-br from-stone-800 to-stone-950"
              style={{
                boxShadow:
                  "inset 0 2px 3px rgba(0,0,0,0.8), 0 1px 2px rgba(0,0,0,0.5)",
              }}
            />
            <div
              className="absolute bottom-3 right-3 w-4 h-4 rounded-full bg-gradient-to-br from-stone-800 to-stone-950"
              style={{
                boxShadow:
                  "inset 0 2px 3px rgba(0,0,0,0.8), 0 1px 2px rgba(0,0,0,0.5)",
              }}
      ...
      <div className="relative px-4 pb-8 sm:px-8">
        <div className="mx-auto w-full max-w-7xl">
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(to bottom, #704214 0%, #5a3516 100%)",
              boxShadow:
          ...
          {/* 선반 본체 */}
          <div
            className="relative w-full min-h-[13rem] sm:min-h-[11rem] md:min-h-[10rem] lg:min-h-[8.5rem] px-3 py-4 sm:px-6 sm:py-6 lg:px-8 lg:py-6"
            style={{
              background:
                "linear-gradient(to bottom, #5a3516 0%, #3d2410 100%)",
              boxShadow: `
          ...
          >
            ...
            <div className="relative z-10 flex flex-col items-center gap-4 pt-12 sm:flex-row sm:items-end sm:justify-center sm:gap-3 sm:pt-14 md:gap-4 md:pt-10 lg:gap-6 xl:gap-8">
                ...
                >
                  <div className="relative w-32 h-40 flex items-end justify-center">
                    <div className="relative w-28 h-32">
                      {/* 맨 아래 종이 */}
                      <div
                        className="absolute bottom-0 left-1/2 -translate-x-1/2 rotate-2 w-24 h-28 bg-gradient-to-br from-slate-100 to-slate-200 rounded-sm border border-slate-300"
                        style={{
                          boxShadow:
                      ...
                      {/* 중간 종이 */}
                      <div
                        className="absolute bottom-1 left-1/2 -translate-x-1/2 -rotate-1 w-24 h-28 bg-gradient-to-br from-white to-slate-100 rounded-sm border border-slate-300"
                        style={{
                          boxShadow:
                      ...
                      {/* 맨 위 종이 */}
                      <div
                        className="absolute bottom-2 left-1/2 -translate-x-1/2 w-24 h-28 bg-gradient-to-br from-white to-slate-50 rounded-sm border border-slate-300"
                        style={{
                          boxShadow:
                      ...
                      <div className="absolute top-0 right-0 w-20 h-5 rotate-45 origin-center z-10">
                        <div
                          className="absolute inset-0 bg-gradient-to-br from-yellow-600 via-amber-500 to-yellow-700 rounded-full border border-amber-800"
                          style={{
                            boxShadow:
                        ...
                        <div
                          className="absolute right-0 top-1/2 -translate-y-1/2 w-3 h-4 bg-gradient-to-r from-amber-800 to-stone-900"
                          style={{ clipPath: "polygon(0 0, 100% 50%, 0 100%)" }}
                        />
                        <div
                          className="absolute left-0 top-1/2 -translate-y-1/2 w-3 h-full bg-gradient-to-br from-pink-400 to-pink-600 rounded-l-full border-l-2 border-pink-700"
                          style={{
                            boxShadow:
                ...
                >
                  <div className="relative w-24 h-32 flex items-end justify-center">
                    <div className="relative w-20 h-28">
                      ...
                      {/* 자 */}
                      <div
                        className="absolute bottom-12 left-3 w-2 h-20 rotate-[-25deg] origin-bottom bg-gradient-to-r from-amber-100 to-amber-200 border border-amber-400 opacity-80"
                        style={{
                          boxShadow:
                      ...
                      >
                        ...
                        <div
                          className="absolute -bottom-1 left-1/2 -translate-x-1/2 w-2 h-2 bg-gradient-to-b from-stone-700 to-black"
                      ...
                      {/* 연필 오른쪽 (주황색) */}
                      <div
                        className="absolute bottom-12 right-2 w-3 h-15 rotate-[15deg] origin-bottom rounded-t-full border border-orange-700"
                        style={{
                          background:
              ...
              <div className="flex w-full flex-wrap justify-center gap-3 items-end sm:w-auto sm:gap-4">
                ...
                <button
                  className="group relative hover:scale-105 transition-transform"
                  onClick={() => setShowRemoveRewardModal(true)}
                >
                ...
                >
                  <div className="relative w-32 h-40 flex items-center justify-center">
                    ...
                    >
                      <div
                        className="absolute top-3 left-1/2 -translate-x-1/2 w-16 h-2.5 bg-gradient-to-b from-stone-950 to-stone-800 rounded-full border border-stone-900"
                    ...
                    <div className="relative w-32 h-36">
                      ...
                      <div
                        ...
                        style={{
                          ...
                          boxShadow:
                            "inset -2px 0 4px rgba(255,255,255,0.3), 2px 0 6px rgba(0,0,0,0.4)",
                        }}
                      >
                      ...
                      <div className="absolute inset-0 flex items-center justify-center gap-2 z-10">
                        ...
                        <span
                          className="text-amber-900 font-bold text-[11px] leading-tight"
                          style={{
        ...
        {/* 가판대 다리 */}
        <div className="mx-auto flex justify-around px-10 sm:px-24 md:px-32 lg:px-40">
          <div
            className="w-6 h-12 rounded-b-lg"
            style={{
              background:
                "linear-gradient(to bottom, #3d2410 0%, #5a3516 100%)",
              boxShadow: `
